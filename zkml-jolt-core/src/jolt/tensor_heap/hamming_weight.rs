...
use jolt_core::{field::JoltField, poly::multilinear_polynomial::{BindingOrder, MultilinearPolynomial}, subprotocols::sumcheck::{BatchableSumcheckInstance, SumcheckInstanceProof}, utils::{thread::unsafe_allocate_zero_vec, transcript::Transcript}};
...
pub fn prove_ra_hamming_weight<F: JoltField, ProofTranscript: Transcript>(
    trace: &[JoltONNXCycle],
    eq_r_cycle: Vec<F>,
    K: usize,
    d: usize,
